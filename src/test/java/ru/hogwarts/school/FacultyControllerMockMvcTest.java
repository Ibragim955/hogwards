...
import ru.hogwarts.school.service.implemention.FacultyServiceImpl;
...
//        faculty.setId(1L);
//
//        Collection<Student> student = List.of(new Student("name",12));
...
//        Faculty faculty = new Faculty("name","white");
//
